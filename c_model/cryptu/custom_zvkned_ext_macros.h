...
#define SPLIT32x4_to_8x16(DST, IN3, IN2, IN1, IN0) \
{ \
(DST[15]) = (uint8_t) ((IN3 >> 24) & 0xFF); \
(DST[14]) = (uint8_t) ((IN3 >> 16) & 0xFF); \
(DST[13]) = (uint8_t) ((IN3 >> 8) & 0xFF); \
(DST[12]) = (uint8_t) ((IN3 >> 0) & 0xFF); \
(DST[11]) = (uint8_t) ((IN2 >> 24) & 0xFF); \
(DST[10]) = (uint8_t) ((IN2 >> 16) & 0xFF); \
(DST[9]) = (uint8_t) ((IN2 >> 8) & 0xFF); \
(DST[8]) = (uint8_t) ((IN2 >> 0) & 0xFF); \
(DST[7]) = (uint8_t) ((IN1 >> 24) & 0xFF); \
(DST[6]) = (uint8_t) ((IN1 >> 16) & 0xFF); \
(DST[5]) = (uint8_t) ((IN1 >> 8) & 0xFF); \
(DST[4]) = (uint8_t) ((IN1 >> 0) & 0xFF); \
(DST[3]) = (uint8_t) ((IN0 >> 24) & 0xFF); \
(DST[2]) = (uint8_t) ((IN0 >> 16) & 0xFF); \
(DST[1]) = (uint8_t) ((IN0 >> 8) & 0xFF); \
(DST[0]) = (uint8_t) ((IN0 >> 0) & 0xFF); \
}

#define MERGE8x16_to_32x4(DST3, DST2, DST1, DST0, IN) \
{ \
(DST3) = ((uint32_t) ((IN[15])) << 24) | ((uint32_t) ((IN[14]) << 16)) | ((uint32_t) ((IN[13])) << 8) | ((uint32_t) ((IN[12]))); \
(DST2) = ((uint32_t) ((IN[11])) << 24) | ((uint32_t) ((IN[10]) << 16)) | ((uint32_t) ((IN[9])) << 8) | ((uint32_t) ((IN[8]))); \
(DST1) = ((uint32_t) ((IN[7])) << 24) | ((uint32_t) ((IN[6]) << 16)) | ((uint32_t) ((IN[5])) << 8) | ((uint32_t) ((IN[4]))); \
(DST0) = ((uint32_t) ((IN[3])) << 24) | ((uint32_t) ((IN[2]) << 16)) | ((uint32_t) ((IN[1])) << 8) | ((uint32_t) ((IN[0]))); \
}
...
static constexpr uint8_t kRoundConstants2[7] = {
    0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40,
};
static constexpr uint8_t kRoundConstants1[10] = {
    0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36
};

//Output: vd = {w0, w1, w2, w3}
void vaeskf2(uint32_t *vs2_3, uint32_t *vd_0, uint32_t *vd_1, uint32_t *vd_2, uint32_t *vd_3, uint8_t *imm, uint32_t *vd_out_0, uint32_t *vd_out_1, uint32_t *vd_out_2, uint32_t *vd_out_3) \
{
    const uint8_t zimm4 = (*imm) & 0xF;
    const uint8_t round = ((2 <= zimm4) && (zimm4 <= 14)) ? zimm4 : (zimm4 ^ 0x8);
    uint32_t temp = (*vs2_3);
    ...
    if (is_even_round) {
        const uint32_t rcon = kRoundConstants2[(round >> 1) - 1];
        temp = temp ^ rcon;
    }
    const uint32_t w0 = (*vd_0) ^ temp;
    const uint32_t w1 = (*vd_1) ^ w0;
    const uint32_t w2 = (*vd_2) ^ w1;
    const uint32_t w3 = (*vd_3) ^ w2;
    *vd_out_0 = w0;
    *vd_out_1 = w1;
    *vd_out_2 = w2;
    *vd_out_3 = w3;
...
//Output: vd = {w0, w1, w2, w3}
void vaeskf1(uint32_t *vs2_0, uint32_t *vs2_1, uint32_t *vs2_2, uint32_t *vs2_3, uint8_t *imm, uint32_t *vd_out_0, uint32_t *vd_out_1, uint32_t *vd_out_2, uint32_t *vd_out_3)
{
    const uint8_t zimm4 = (*imm) & 0xF;
    const uint8_t round = ((1 <= zimm4) && (zimm4 <= 10)) ? zimm4 : (zimm4 ^ 0x8);
    const uint32_t rcon = kRoundConstants1[round - 1];
    uint32_t temp = (*vs2_3);
    temp = (temp >> 8) | (temp << 24);
    temp = (((uint32_t)AES_ENC_SBOX[(temp >> 24) & 0xFF] << 24) |
            ((uint32_t)AES_ENC_SBOX[(temp >> 16) & 0xFF] << 16) |
            ...
            ((uint32_t)AES_ENC_SBOX[(temp >>  0) & 0xFF] <<  0));
    temp = temp ^ rcon;
    const uint32_t w0 = (*vs2_0) ^ temp;
    const uint32_t w1 = (*vs2_1) ^ w0;
    const uint32_t w2 = (*vs2_2) ^ w1;
    const uint32_t w3 = (*vs2_3) ^ w2;
    *vd_out_0 = w0;
    *vd_out_1 = w1;
    *vd_out_2 = w2;
    *vd_out_3 = w3;
...
void vaesz(uint32_t *vs2_0, uint32_t *vs2_1, uint32_t *vs2_2, uint32_t *vs2_3, uint32_t *vd_0, uint32_t *vd_1, uint32_t *vd_2, uint32_t *vd_3, uint32_t *vd_out_0, uint32_t *vd_out_1, uint32_t *vd_out_2, uint32_t *vd_out_3)
    {
    ...
    // during the loop.
    const uint16_t scalar_key[] = {uint16_t(*vs2_3 >> 16), uint16_t(*vs2_3), uint16_t(*vs2_2 >> 16), uint16_t(*vs2_2), uint16_t(*vs2_1 >> 16), uint16_t(*vs2_1), uint16_t(*vs2_0 >> 16), uint16_t(*vs2_0)};
    // Per Element Group body.
    uint16_t vd[] = {uint16_t(*vd_3 >> 16), uint16_t(*vd_3), uint16_t(*vd_2 >> 16), uint16_t(*vd_2), uint16_t(*vd_1 >> 16), uint16_t(*vd_1), uint16_t(*vd_0 >> 16), uint16_t(*vd_0)};
    // Produce vd = vd ^ "common key from vs2".
    {
    EGU8x16_XOR(vd, vd, scalar_key);
    }
    // NOTE: Chose 16x8 instead in the end, because it seems tedious and unneccessary to do 8x16 if it's just an XOR of two vectors.
    *vd_out_3 = (uint32_t(vd[0]) << 16) | uint32_t(vd[1]);
    *vd_out_2 = (uint32_t(vd[2]) << 16) | uint32_t(vd[3]);
    *vd_out_1 = (uint32_t(vd[4]) << 16) | uint32_t(vd[5]);
    *vd_out_0 = (uint32_t(vd[6]) << 16) | uint32_t(vd[7]);
};

void vaesef(uint32_t *vs2_0, uint32_t *vs2_1, uint32_t *vs2_2, uint32_t *vs2_3, uint32_t *vd_0, uint32_t *vd_1, uint32_t *vd_2, uint32_t *vd_3, uint32_t *vd_out_0, uint32_t *vd_out_1, uint32_t *vd_out_2, uint32_t *vd_out_3)
{
    ...
    SPLIT32x4_to_8x16(aes_state, *vd_3, *vd_2, *vd_1, *vd_0);
    SPLIT32x4_to_8x16(round_key, *vs2_3, *vs2_2, *vs2_1, *vs2_0);
    ...
    MERGE8x16_to_32x4(*vd_out_3, *vd_out_2, *vd_out_1, *vd_out_0, aes_state);
};

void vaesem(uint32_t *vs2_0, uint32_t *vs2_1, uint32_t *vs2_2, uint32_t *vs2_3, uint32_t *vd_0, uint32_t *vd_1, uint32_t *vd_2, uint32_t *vd_3, uint32_t *vd_out_0, uint32_t *vd_out_1, uint32_t *vd_out_2, uint32_t *vd_out_3)
{
    // For AES128, AES192, or AES256, state and key are 128b/16B values:
    //  - vd contains the input state,
    //  - vs2 contains the round key,
...
void vaesdf(uint32_t *vs2_0, uint32_t *vs2_1, uint32_t *vs2_2, uint32_t *vs2_3, uint32_t *vd_0, uint32_t *vd_1, uint32_t *vd_2, uint32_t *vd_3, uint32_t *vd_out_0, uint32_t *vd_out_1, uint32_t *vd_out_2, uint32_t *vd_out_3)
{
    // For AES128, AES192, or AES256, state and key are 128b/16B values:
    //  - vd contains the input state,
    //  - vs2 contains the round key,
...
void vaesdm(uint32_t *vs2_0, uint32_t *vs2_1, uint32_t *vs2_2, uint32_t *vs2_3, uint32_t *vd_0, uint32_t *vd_1, uint32_t *vd_2, uint32_t *vd_3, uint32_t *vd_out_0, uint32_t *vd_out_1, uint32_t *vd_out_2, uint32_t *vd_out_3)
{
    // For AES128, AES192, or AES256, state and key are 128b/16B values:
    //  - vd contains the input state,
    //  - vs2 contains the round key,

 ...
 ***********/
  ...
  logic [31:0] t_a_32, t_b_32, t_c_32, t_d_32, t_e_32, t_f_32, t_g_32, t_h_32;
  logic [63:0] a_64, b_64, c_64, d_64, e_64, f_64, g_64, h_64;
  logic [63:0] t_a_64, t_b_64, t_c_64, t_d_64, t_e_64, t_f_64, t_g_64, t_h_64;
 ...
 *********************/
  ...
  always_comb begin
    ...
    if (sha_op_i[0] == 1'b1) begin // SHA-512 (SEW64)
      ...
      T1_64 = t_h_64 + sum1_64(t_e_64) + ch_64(t_e_64, t_f_64, t_g_64) + W1_64;
      T2_64 = sum0_64(t_a_64) + maj_64(t_a_64, t_b_64, t_c_64);
      ...
      T1_32 = t_h_32 + sum1_32(t_e_32) + ch_32(t_e_32, t_f_32, t_g_32) + W1_32;
      T2_32 = sum0_32(t_a_32) + maj_32(t_a_32, t_b_32, t_c_32);
